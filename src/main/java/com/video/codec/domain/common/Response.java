package com.video.codec.domain.common;

import com.video.codec.exception.BusinessException;
import com.video.codec.exception.CommonException;
...
public class Response<T> implements Serializable {
    ...
    public static <T> Response<T> failed(Exception e) {
        return newResponse(FAILED, "500", e.getMessage(), null);
    }
